...
const towerAndBase: Composition3DDefinition = {
  ...
  controls: {
    towerHeight: { type: "slider", label: "Tower Height", default: 3, min: 1.5, max: 12, group: "Structure" },
    capSharpness: { type: "slider", label: "Cap Sharpness", default: 4, min: 1, max: 20, group: "Structure" },
    canopyRadius: { type: "slider", label: "Canopy Radius", default: 2.2, min: 1, max: 8, group: "Shape" },
    canopySag: { type: "slider", label: "Canopy Sag", default: 0.6, min: 0.1, max: 4, group: "Shape" },
    ringSize: { type: "slider", label: "Ring Size", default: 1.8, min: 0.5, max: 6, group: "Shape" },
    ringThickness: { type: "slider", label: "Ring Thickness", default: 0.12, min: 0.03, max: 0.4, group: "Shape" },
    towerRadius: { type: "slider", label: "Tower Radius", default: 0.5, min: 0.2, max: 4, group: "Shape" },
    towerTwist: { type: "slider", label: "Tower Twist", default: 0.5, min: 0, max: 10, group: "Shape" },
