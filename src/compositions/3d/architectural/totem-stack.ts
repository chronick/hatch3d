...
const totemStack: Composition3DDefinition = {
  ...
  controls: {
    tiers: { type: "slider", label: "Tiers", default: 5, min: 2, max: 20, step: 1, group: "Structure" },
    spacing: { type: "slider", label: "Spacing", default: 1.5, min: 0.5, max: 8, group: "Structure" },
    baseSize: { type: "slider", label: "Base Size", default: 1.0, min: 0.5, max: 4.0, group: "Structure" },
    taper: { type: "slider", label: "Taper", default: 0.12, min: 0, max: 0.5, group: "Structure" },
    hyperboloidRadius: { type: "slider", label: "Hyp. Radius", default: 0.7, min: 0.3, max: 4.0, group: "Shape" },
    hyperboloidHeight: { type: "slider", label: "Hyp. Height", default: 1.3, min: 0.5, max: 6.0, group: "Shape" },
    baseTwist: { type: "slider", label: "Base Twist", default: 0.3, min: 0, max: 5, group: "Shape" },
    twistGrowth: { type: "slider", label: "Twist Growth", default: 0.4, min: 0, max: 4, group: "Shape" },
    capRadius: { type: "slider", label: "Cap Radius", default: 0.8, min: 0.3, max: 4.0, group: "Shape" },
    capSag: { type: "slider", label: "Cap Sag", default: 0.2, min: 0, max: 2.0, group: "Shape" },
    capSharpness: { type: "slider", label: "Cap Sharpness", default: 3, min: 1, max: 20, group: "Shape" },
