...
const dnaHelix: Composition3DDefinition = {
  ...
  controls: {
    strandTwist: { type: "slider", label: "Strand Twist", default: 3, min: 1, max: 15, group: "Structure" },
    rungs: { type: "slider", label: "Rungs", default: 8, min: 2, max: 50, step: 1, group: "Structure" },
    height: { type: "slider", label: "Height", default: 6, min: 3, max: 20, group: "Structure" },
    strandWidth: { type: "slider", label: "Strand Width", default: 0.6, min: 0.2, max: 3.0, group: "Shape" },
    strandBulge: { type: "slider", label: "Strand Bulge", default: 0.5, min: 0, max: 1, group: "Shape" },
    rungRadius: { type: "slider", label: "Rung Radius", default: 0.8, min: 0.3, max: 4.0, group: "Shape" },
    rungThickness: { type: "slider", label: "Rung Thickness", default: 0.04, min: 0.02, max: 0.15, group: "Shape" },
    rungSquish: { type: "slider", label: "Rung Squish", default: 3, min: 1, max: 10, group: "Shape" },
