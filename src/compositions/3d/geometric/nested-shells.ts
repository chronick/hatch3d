...
const nestedShells: Composition3DDefinition = {
  ...
  controls: {
    shells: { type: "slider", label: "Shells", default: 4, min: 1, max: 20, step: 1, group: "Structure" },
    outerRadius: { type: "slider", label: "Outer Radius", default: 1.8, min: 0.8, max: 6.0, group: "Structure" },
    innerRadius: { type: "slider", label: "Inner Radius", default: 0.8, min: 0.2, max: 4.0, group: "Structure" },
    height: { type: "slider", label: "Height", default: 3, min: 1.5, max: 12, group: "Structure" },
    heightGrowth: { type: "slider", label: "Height Growth", default: 1.5, min: 0, max: 6, group: "Structure" },
    outerTwist: { type: "slider", label: "Outer Twist", default: 0.5, min: 0, max: 8, group: "Shape" },
    innerTwist: { type: "slider", label: "Inner Twist", default: 2.0, min: 0.5, max: 12, group: "Shape" },
    ...
    capSharpness: { type: "slider", label: "Cap Sharpness", default: 6, min: 1, max: 20, group: "Shape" },
