...
const starburst: Composition3DDefinition = {
  ...
  controls: {
    arms: { type: "slider", label: "Arms", default: 8, min: 3, max: 30, step: 1, group: "Structure" },
    reach: { type: "slider", label: "Reach", default: 1.8, min: 0.5, max: 8.0, group: "Structure" },
    hubSize: { type: "slider", label: "Hub Size", default: 0.5, min: 0.15, max: 3.0, group: "Structure" },
    armHeight: { type: "slider", label: "Arm Height", default: 0.3, min: 0.1, max: 3.0, group: "Shape" },
    heightVariation: { type: "slider", label: "Height Var.", default: 0.2, min: 0, max: 2.0, group: "Shape" },
    spreadVariation: { type: "slider", label: "Spread Var.", default: 0.4, min: 0, max: 4.0, group: "Shape" },
    baseFanAngle: { type: "slider", label: "Fan Angle", default: 0.4, min: 0.1, max: 3.0, group: "Shape" },
    fanAngleVariation: { type: "slider", label: "Fan Var.", default: 0.15, min: 0, max: 1.5, group: "Shape" },
