...
const vortexTunnel: Composition3DDefinition = {
  ...
  controls: {
    rings: { type: "slider", label: "Rings", default: 7, min: 3, max: 40, step: 1, group: "Structure" },
    verticalSpan: { type: "slider", label: "Vertical Span", default: 8, min: 2, max: 25, group: "Structure" },
    baseRadius: { type: "slider", label: "Base Radius", default: 1.2, min: 0.5, max: 5.0, group: "Structure" },
    amplitude: { type: "slider", label: "Amplitude", default: 0.6, min: 0, max: 5, group: "Shape" },
    ...
    spineTwist: { type: "slider", label: "Spine Twist", default: 4, min: 1, max: 20, group: "Shape" },
